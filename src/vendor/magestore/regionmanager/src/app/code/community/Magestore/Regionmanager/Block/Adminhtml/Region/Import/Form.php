...
class Magestore_Regionmanager_Block_Adminhtml_Region_Import_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm(){
		...
		$fieldset = $form->addFieldset('profile_fieldset',array('legend'=>Mage::helper('regionmanager')->__('Import Region')));
